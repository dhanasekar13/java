 ...
 */
 class Way2SMS {
    ...
    {  
        final String USERNAME="7299347253";//REQUIRED
        final String PASSWORD="7299347253";//REQUIRED
        ...
        StringBuilder phoneNumber= new StringBuilder("7299347253");
        StringBuilder message=new StringBuilder("do at last find out");
